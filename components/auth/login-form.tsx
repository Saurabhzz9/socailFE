          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24">
                ...
                <path
                  fill="#FBBC05"
                  d="M12 23c4.3 0 8.01-2.47 9.82-6.09l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"
                />
                <path
                  fill="#EA4335"
                  d="M12 4.44c1.64 0 3.12.56 4.28 1.66l3.2-3.2C17.46 1.61 14.97.5 12 .5 7.7.5 3.99 2.97 2.18 6.59l3.57 2.77C6.71 6.37 9.14 4.44 12 4.44z"
                />
              </svg>
            ...
            <div className="text-xs text-muted-foreground text-center mt-4">
              By signing in, you agree to our <a href="/terms.html" target="_blank" rel="noopener noreferrer" className="underline">Terms</a> and <a href="/privacy.html" target="_blank" rel="noopener noreferrer" className="underline">Privacy Policy</a>.
            </div>
          </form>
