        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
              {/* Top Badge */}
              <Badge className="mb-6 bg-gray-800 text-blue-400 border-gray-700 shadow-lg">
              ...
              <div className="space-y-6 mb-12">
                <h1 className="text-4xl lg:text-6xl font-bold leading-tight text-white">
                  ...
                  <span className="text-blue-400">Quolo</span>
                </h1>
              ...
              <div className="flex items-center justify-center lg:justify-start gap-4 mb-8">
                ...
                <div>
                  ...
                  <span className="text-sm text-gray-300">
                    Loved by{" "}
                    <span className="font-semibold animate-pulse">8,999</span>{" "}
                    small businesses
                  </span>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl p-8 border border-gray-700 shadow-2xl">
                {/* Browser Header */}
                ...
                {/* Dashboard Content with all platform icons */}
                <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-2xl p-8 text-center">
                  ...
                  <h3 className="text-white font-semibold text-lg mb-6">
                    Dashboard auto-posting simulation
                  </h3>
                  ...
                  <div className="flex justify-center items-center gap-3 mb-4">
                    ...
                    <Facebook className="w-6 h-6 text-blue-200" />
                  ...
                  {/* Success indicator */}
                  <div className="bg-green-500/20 border border-green-400/30 px-4 py-2 rounded-full mx-auto w-fit">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-8 border border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <div className="text-4xl font-bold text-white mb-2">10,000+</div>
              <div className="text-gray-300">Posts Scheduled</div>
            </div>
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-8 border border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <div className="text-4xl font-bold text-white mb-2">3+ Hours</div>
      ...
      <section id="features" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="p-6 bg-gradient-to-br from-slate-800 to-slate-900 border-gray-700 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
      ...
      <section className="py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-300 mb-10">
            A quick 2-min walkthrough of how effortless your content scheduling
            can be.
          </p>

          <div className="aspect-video rounded-xl overflow-hidden shadow-2xl border border-gray-700 bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-br from-slate-800 to-slate-900 border border-gray-700 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">Built for speed, not headaches.</p>
            </div>
      ...
      <section id="testimonials" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="p-6 bg-gradient-to-br from-slate-800 to-slate-900 border-gray-700 shadow-lg">
              <CardContent className="p-0">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-gray-400 text-sm">Indie Maker</div>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-0">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-gray-400 text-sm">Growth Manager</div>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-0">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-gray-400 text-sm">Dev Founder</div>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      <section id="pricing" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">Cancel anytime. Start free.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {/* Starter Plan */}
            <Card className="p-8 bg-gradient-to-br from-slate-800 to-slate-900 border-gray-700 hover:border-blue-500 transition-colors">
              <CardContent className="p-0">
                <div className="text-center">
                  ...
                  <p className="text-gray-300 mb-6">Perfect for individuals</p>

                  <Button className="w-full mb-6 bg-gray-700 hover:bg-gray-600 text-white border-0">
                    Start Free Trial
                  </Button>
            ...
            {/* Creator Plan */}
            <Card className="p-8 bg-gradient-to-br from-slate-800 to-slate-900 border-blue-500 relative overflow-hidden">
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 bg-blue-600 text-white px-4 py-1 text-sm font-medium rounded-b">
                Most Popular
              </div>
              <CardContent className="p-0 pt-4">
                <div className="text-center">
                  ...
                  <div className="text-4xl font-bold mb-4 text-white">
                    $18<span className="text-lg text-gray-400">/month</span>
                  </div>
                  ...
                  <div className="text-left space-y-3">
                    <div className="flex items-center">
                      <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
                      <span className="text-gray-300">15 Social Accounts</span>
                    </div>
                    <div className="flex items-center">
                      <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
                      <span className="text-gray-300">Auto-posting</span>
            ...
            <Card className="p-8 bg-gradient-to-br from-slate-800 to-slate-900 border-gray-700 hover:border-blue-500 transition-colors">
              <CardContent className="p-0">
                <div className="text-center">
                  ...
                  <div className="text-4xl font-bold mb-4 text-white">
                    $27<span className="text-lg text-gray-400">/month</span>
                  </div>
          ...
          <div className="text-center mt-12">
            <p className="text-gray-300">🧪 Try it free. No card required.</p>
          </div>
        </div>
      </section>
